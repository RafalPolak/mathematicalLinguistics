...
automat.controller('automatCtrl', function ($scope) {
    ...
    //fun przyciski
    $scope.addToPrice = function add(coin) {
        ...
        if (coin === 1) {
            ...
            /*
                np. mamy stan 0 i wrzucamy 1 to przechodzimy do stanu 2 co odpowiada jedynce,
                ale żeby otrzymać 1 z tablicy stanów to musimy wiedziec że:
    ...
    var isTooMuch = function tooMuch() {
